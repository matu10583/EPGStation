...
export class AddLastPlayTime1758446254353 implements MigrationInterface {
    name = 'AddLastPlayTime1758446254353';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`recorded\` ADD \`lastPlayTime\` int UNSIGNED NULL`);
        ...
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`halfWidthExtended\` \`halfWidthExtended\` text NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`recorded\` CHANGE \`rawExtended\` \`rawExtended\` text NULL`);
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`videoStreamContent\` \`videoStreamContent\` int NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`videoComponentType\` \`videoComponentType\` int NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`recorded\` CHANGE \`audioSamplingRate\` \`audioSamplingRate\` int NULL`);
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`audioComponentType\` \`audioComponentType\` int NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`periodToAvoidDuplicate\` \`periodToAvoidDuplicate\` int NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`rule\` CHANGE \`tags\` \`tags\` text NULL`);
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`parentDirectoryName\` \`parentDirectoryName\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`parentDirectoryName1\` \`parentDirectoryName1\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`parentDirectoryName2\` \`parentDirectoryName2\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`parentDirectoryName3\` \`parentDirectoryName3\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`parentDirectoryName\` \`parentDirectoryName\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`programUpdateTime\` \`programUpdateTime\` bigint NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`halfWidthDescription\` \`halfWidthDescription\` text NULL`,
        );
        ...
        await queryRunner.query(`ALTER TABLE \`reserve\` CHANGE \`rawExtended\` \`rawExtended\` text NULL`);
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`videoStreamContent\` \`videoStreamContent\` int NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`videoComponentType\` \`videoComponentType\` int NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`reserve\` CHANGE \`audioSamplingRate\` \`audioSamplingRate\` int NULL`);
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`audioComponentType\` \`audioComponentType\` int NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`program\` CHANGE \`description\` \`description\` text NULL`);
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`halfWidthDescription\` \`halfWidthDescription\` text NULL`,
        );
        ...
        await queryRunner.query(`ALTER TABLE \`program\` CHANGE \`rawExtended\` \`rawExtended\` text NULL`);
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`videoStreamContent\` \`videoStreamContent\` int NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`videoComponentType\` \`videoComponentType\` int NULL`,
        );
        await queryRunner.query(`ALTER TABLE \`program\` CHANGE \`audioSamplingRate\` \`audioSamplingRate\` int NULL`);
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`audioComponentType\` \`audioComponentType\` int NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`channel\` CHANGE \`remoteControlKeyId\` \`remoteControlKeyId\` int NULL`,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`rawExtended\` \`rawExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`program\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`rawExtended\` \`rawExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`programId\` \`programId\` bigint NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`encodeMode3\` \`encodeMode3\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`encodeMode2\` \`encodeMode2\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`encodeMode1\` \`encodeMode1\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`reserve\` CHANGE \`ruleUpdateCnt\` \`ruleUpdateCnt\` int NULL DEFAULT 'NULL'`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`recordedFormat\` \`recordedFormat\` text NULL DEFAULT 'NULL'`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`searchPeriods\` \`searchPeriods\` text NULL DEFAULT 'NULL'`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE \`rule\` CHANGE \`ignoreKeyword\` \`ignoreKeyword\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`rawHalfWidthExtended\` \`rawHalfWidthExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`rawExtended\` \`rawExtended\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`,
        );
        await queryRunner.query(
            `ALTER TABLE \`recorded\` CHANGE \`programId\` \`programId\` bigint NULL DEFAULT 'NULL'`,
        );
        ...
        await queryRunner.query(`ALTER TABLE \`recorded\` DROP COLUMN \`lastPlayTime\``);
    }
}
